    ...
    <div class="row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <div class="peers">
                ...
                <div class="peer">
                    <Link class="btn btn-primary btn-sm" :href="`/RiskManagement/create/${revid}`">Add Risk Management</Link>
                                ...
                                <td>
                                    <div class="dropdown dropstart" >
                                        ...
                                        <ul class="dropdown-menu action-dropdown"  aria-labelledby="dropdownMenuButton1">
                                            <li><Link class="dropdown-item" :href="`/RiskManagement/${dat.id}/edit`">Edit</Link></li>
                                            <li><Link class="text-danger dropdown-item" @click="deleteRiskManagement(dat.id)">Delete</Link></li>
                                        </ul>
                                    </div>
                                </td>
                            </tr>
