<template>
    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>Hospital Output</h3>
            <div class="peers">
                <div class="peer mR-10">
                    <input v-model="search" type="text" class="form-control form-control-sm" placeholder="Search...">
                </div>
                <div class="peer">
                    <Link class="btn btn-primary btn-sm" :href="`/hospitals/create/${idPaps}`">Add HPCR</Link>
                                ...
                                <td>
                                    <div class="dropdown dropstart" >
                                        ...
                                        <ul class="dropdown-menu action-dropdown"  aria-labelledby="dropdownMenuButton1">
                                            <li><Link class="dropdown-item" :href="`/hospital_division/${dat.id}`">Add Hospital Division Output</Link></li>
                                            <li><Link class="dropdown-item" :href="`/hospitals/${dat.id}/edit`">Edit</Link></li>
