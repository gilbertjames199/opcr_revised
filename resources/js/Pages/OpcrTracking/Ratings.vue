<template>
    <Head>
        <title>OPCR Ratings</title>
    </Head>
  <div class="w-100 p-4">
    <div class="mb-4">
      <h2 class="mb-1 fw-bold" style="color: #2c3e50;">OPCR Ratings</h2>
      <p class="text-muted" style="font-size: 0.95rem;">View and manage ratings by year and semester</p>
    </div>
    <!-- ================= YEAR TABLE ================= -->
