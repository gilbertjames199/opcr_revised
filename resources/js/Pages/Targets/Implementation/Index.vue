<template>
    ...
    <div class="row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <Link :href="`/implementation/${idrev_plan}`">
                                    ...
                                    <div class="dropdown dropstart" >
                                        ...
                                        <ul class="dropdown-menu action-dropdown"  aria-labelledby="dropdownMenuButton1">
                                            ...
                                            <li>
                                                ...
                                                <Link class="dropdown-item" :href="`/targets/${imp_id}/implementation/${dat.id}/edit`">Edit</Link>
                                            </li>
                                            <li><Link class="text-danger dropdown-item" @click="deleteTarget(dat.id)">Delete</Link></li>
                                        </ul>
                                    </div>
                                </td>
