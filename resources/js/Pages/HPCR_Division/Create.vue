<template>
    <div class="relative row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>{{ pageTitle }} Hospital Division Output</h3>
            <!-- <h4>{{ paps }}</h4> -->
            <Link :href="`/hospital_division/${idhpcr}`">
...
<h5>{{"PAPS: " + hpcr.output }}</h5>

        <div class="col-md-8">
            <form @submit.prevent="submit()">
                <input type="hidden" required>

                <input type="hidden" v-model="form.idhpcr" class="form-control" autocomplete="positionchrome-off">
