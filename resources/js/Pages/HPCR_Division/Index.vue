<template>
    ...
    <div class="row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            <h4>Hospital Output: {{ HPCR.output }}</h4>

        </div>
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>Hospital Division Output</h3>
            <div class="peers">
                <div class="peer mR-10">
                    <input v-model="search" type="text" class="form-control form-control-sm" placeholder="Search...">
                </div>
                <div class="peer">
                    <Link class="btn btn-primary btn-sm" :href="`/hospital_division/create/${idhpcr}`">Add Hospital DPCR</Link>
                    <button class="btn btn-primary btn-sm mL-2 text-white" @click="showFilter()">Filter</button>
                </div>&nbsp;
                <Link :href="`/hospitals/${HPCR.idpaps}`">
                    ...
                    <table class="table table-sm table-borderless table-striped table-hover">
                        <thead>
                            <tr class="bg-secondary text-white">
                                <th>Hospital Division Output</th>
                                ...
                                <td>
                                    <div class="dropdown dropstart" >
                                        ...
                                        <ul class="dropdown-menu action-dropdown"  aria-labelledby="dropdownMenuButton1">
                                            <li><Link class="dropdown-item" :href="`/hospital_section/${dat.id}`">Add Section Output</Link></li>
                                            <li><Link class="dropdown-item" :href="`/hospital_division/${dat.id}/edit`">Edit</Link></li>
