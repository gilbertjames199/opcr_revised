    ...
    <div class="row gap-20 masonry pos-r">
        ...
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <div class="peers">
                ...
                <div class="peer">
                    <Link class="btn btn-primary btn-sm" :href="`/division_outputs/create`">Add Division</Link>
                                ...
                                <td>
                                    <div class="dropdown dropstart" >
                                        ...
                                        <ul class="dropdown-menu action-dropdown"  aria-labelledby="dropdownMenuButton1">
                                            <li><Link class="dropdown-item" :href="`/division_outputs/${dat.id}/edit`">Edit</Link></li>
