<template>
    ...
    <div class="row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>OPCR Target Budget</h3>
            <div class="peers">
                <div class="peer mR-10">
                    <input v-model="search" type="text" class="form-control form-control-sm" placeholder="Search...">
                </div>
                <div class="peer mR-10">
                    <Link class="btn btn-primary btn-sm" :href="`/opcrbudgeting/create/${opcr_list_id}`">Create OPCR</Link>
                ...
                &nbsp;
                <div class="peer">
                    <!-- <button @click="submitThis()" class="btn btn-primary btn-sm text-white"8
