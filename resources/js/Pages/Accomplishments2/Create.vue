<template>
    ...
    <div class="relative row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            ...
            <!--:href="`/accomplishments/${form.idtarget }/list`"   {{ form.idtarget }}-->
            <!--form.raao_id: {{ form.raao_id }}
            raao_id: {{ raao_id}}-->
            <Link :href="`/accomplishments/${raao_id}/raao/list`" >
            ...
            <form @submit.prevent="submit()">
                ...
                <div>
                    <div class="relative row gap-20 masonry pos-r">
                        ...
                        <div class="col-md-10">
                            <input type="date"
                                    v-model="form.actual_period_from"
                                    class="form-control"
                                    autocomplete="chrome-off"
                            >
                            <div class="fs-6 c-red-500" v-if="form.errors.actual_period_from">{{ form.errors.actual_period_from }}</div>
                        </div>
                    </div>
                    <div class="relative row gap-20 masonry pos-r">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-10">
                            <input type="date"
                                    v-model="form.actual_period_to"
                                    class="form-control"
                                    autocomplete="chrome-off"
                            >
                            <div class="fs-6 c-red-500" v-if="form.errors.actual_period_to">{{ form.errors.actual_period_to }}</div>
                        </div>
                    </div>
                </div>
                ...
                <input type="text"
                        v-model="form.facilitating_timeliness"
                        class="form-control"
                        autocomplete="chrome-off"
                >
                <div class="fs-6 c-red-500" v-if="form.errors.facilitating_timeliness">{{ form.errors.facilitating_timeliness }}</div>
                ...
                <input type="text"
                        v-model="form.deterring_timeliness"
                        class="form-control"
                        autocomplete="chrome-off"
                >
                <div class="fs-6 c-red-500" v-if="form.errors.deterring_timeliness">{{ form.errors.deterring_timeliness }}</div>

                <label for="">Deterring Concerns</label>
                <input type="text"
                        v-model="form.deterring_concerns"
                        class="form-control"
                        autocomplete="chrome-off"
                >
                ...
                <input type="text"
                        v-model="form.deterring_logistics"
                        class="form-control"
                        autocomplete="chrome-off"
                >
                <div class="fs-6 c-red-500" v-if="form.errors.deterring_logistics">{{ form.errors.deterring_logistics }}</div>

                <label for="">Concerns Timeliness</label>
                <input type="text"
                        v-model="form.concerns_timeliness"
                        class="form-control"
                        autocomplete="chrome-off"
                >
                <div class="fs-6 c-red-500" v-if="form.errors.concerns_timeliness">{{ form.errors.concerns_timeliness }}</div>
                ...
                <div>
                    <div class="relative row gap-20 masonry pos-r">
                        ...
                        <div class="col-md-10">
                            <input type="date"
                                    v-model="form.date_accomplished_from"
                                    class="form-control"
                                    autocomplete="chrome-off"
                            >
                            <div class="fs-6 c-red-500" v-if="form.errors.date_accomplished_from">{{ form.errors.date_accomplished_from }}</div>
                        </div>
                    </div>
                    <div class="relative row gap-20 masonry pos-r">
                        <div class="col-md-1"></div>
                        ...
                        <div class="col-md-10">
                            <input type="date"
                                    v-model="form.date_accomplished_to"
                                    class="form-control"
                                    autocomplete="chrome-off"
                            >
                            <div class="fs-6 c-red-500" v-if="form.errors.date_accomplished_to">{{ form.errors.date_accomplished_to }}</div>
                        </div>
                    </div>
                </div>
                <!--***************-->
                <!--1 {{ can.can_access_validation }}-->
                ...
                &nbsp;
                <Link class="btn btn-danger mt-3" :href="`/accomplishments/${raao_id}/raao/list`"  :disabled="form.processing">
                    Cancel
                </Link>
            </form>
        </div>
