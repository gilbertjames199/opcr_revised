            ...
            <form @submit.prevent="submit()">
                ...
                <div class="tab-content" id="pills-tabContent">
                    ...
                    <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home-tab">
                        <button type="button" class="btn btn-primary text-white" @click="increaseLengthEfficiency">Add</button>
                        <button type="button" class="btn btn-danger text-white" @click="decreaseLengthEfficiency">Remove</button>
                        <fieldset class="border p-4">
                            ...
                            <div v-for="(num_r, index) in form.NumericalRating">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><input type="text" placeholder="Enter numerical rating"  v-model="form.NumericalRating[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td><input type="text" placeholder="Enter adjectival rating" v-model="form.AdjectivalRating[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td style="width: 60%;"><input type="text" placeholder="Enter efficiency" v-model="form.Efficiency[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                    </tr>
                                </table>
                            </div>
                    ...
                    <div class="tab-pane fade" id="pills-profile" role="tabpanel" aria-labelledby="pills-profile-tab">
                        ...
                        <button type="button" class="btn btn-danger text-white" @click="decreaseLengthQuality">Remove</button>
                        <fieldset class="border p-4">
                            ...
                            <div v-for="(num_r, index) in form.NumericalRating1">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><input type="text" placeholder="Enter numerical rating"  v-model="form.NumericalRating1[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td><input type="text" placeholder="Enter adjectival rating" v-model="form.AdjectivalRating1[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td style="width: 60%;"><input type="text" placeholder="Enter Quality" v-model="form.Quality[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                    </tr>
                                </table>
                            </div>
                        </fieldset>
                    ...
                    <div class="tab-pane fade" id="pills-contact" role="tabpanel" aria-labelledby="pills-contact-tab">
                        ...
                        <button type="button" class="btn btn-danger text-white" @click="decreaseLengthTimeliness">Remove</button>
                        <fieldset class="border p-4">
                            ...
                            <div v-for="(num_r, index) in form.NumericalRating2">
                                ...
                                <table class="table table-bordered">
                                    ...
                                    <tr>
                                        <td><input type="text" placeholder="Enter numerical rating"  v-model="form.NumericalRating2[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td><input type="text" placeholder="Enter adjectival rating" v-model="form.AdjectivalRating2[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                        <td style="width: 60%;"><input type="text" placeholder="Enter Timeliness" v-model="form.Timeliness[index]" class="form-control" autocomplete="positionchrome-off"></td>
                                    </tr>
                                </table>
                            </div>
