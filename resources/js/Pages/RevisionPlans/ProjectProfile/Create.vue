<template>
    ...
    <RiskManagementModal v-if="RiskManagementModalVisible" @close-modal-event="closeRiskManagementModal" title="RISK MANAGEMENT"></RiskManagementModal>
    <MonitoringModal v-if="MonitoringModalVisible" @close-modal-event="closeMonitoringModal" title="MONITORING AND EVALUATION"></MonitoringModal>
    <SignatoryModal v-if="SignatoryModalVisible" @close-modal-event="closeSignatoryModal" title="SIGNATORIES"></SignatoryModal>
</template>
<script>
