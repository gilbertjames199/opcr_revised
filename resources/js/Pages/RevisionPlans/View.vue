                                        ...
                                        <tr v-for="(act, subIndex) in dat.activity" :key="subIndex">
                                            ...
                                            <td :class="{
                                                ...
                                                <span v-if="paps.is_strategy_based==0">{{ act.target_indicator }}
                                                    <button v-if="can_view_comment()" class="superscript-btn"
                                                        @click="handleClick('Implementation Plan','activity target indicator',act.target_indicator,'activity target indicator','activity_projects', act, act.comments)">*
                                                    </button>
                                                    <button v-if="has_comment('Implementation Plan','activity target indicator',act.target_indicator,'activity target indicator','activity_projects', act, act.comments)" class="superscript-btn"
                                                        @click="handleClick('Implementation Plan','activity target indicator',act.target_indicator,'activity target indicator','activity_projects', act, act.comments)">*
                                                    </button>
                                                </span>
                                            </td>
