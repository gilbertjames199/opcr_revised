            ...
            <div class="bgc-white p-20 bd">
                <div class="table-responsive">
                    ...
                    <table name="tabel" class="table table-hover table-bordered border-dark">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td colspan="6" align="justify" style="white-space: pre-line">{{ paps.beneficiaries }}</td>
                            </tr>
                    ...
                    <div v-if="data.length>0">
                        <h3><Link>Implementation Plan</Link></h3>
                    ...
                    <div >
                        ...
                        <div v-else>
                            <span style="color:red; font-weight: bold;">
                                ...
                                Click <Link :href="`/budget/${paps.id}`">here</Link> to edit budgetary requirements.
                            </span>
                        </div>
                        <br>
                    </div>
                    ...
                    <div align="justify" style="white-space: pre-line">{{ paps.implementing_team }}</div>
                    ...
                    <div v-else>
                        <span style="color:red; font-weight: bold;">
                            ...
                            Click <Link :href="`/team/${paps.id}/revision/plan/team`">here</Link> to edit implementation team.
                        </span>
                        <br>
                    </div>
                    <br>
                    <!--PARTNERSHIP & SUSTAINABILITY-->
                    <h3 v-if="paps.partnership!==null"><Link>Partnership and Sustainability</Link></h3>
                    <div align="justify" style="white-space: pre-line">{{ paps.partnership }}</div>
                    <br>
                    <br>
                    ...
                    <div align="justify" style="white-space: pre-line">{{ paps.monitoring }}</div>
                    ...
                    <div v-else>
                        <span style="color:red; font-weight: bold;">
                            ...
                            Click <Link :href="`/EvaluationMechanismTool/${paps.id}`">here</Link> to edit monitoring and evaluation.
                        </span>
                        <br><br>
                    </div>
                    <!--RISK MANAGEMENT-->
                    ...
                    <div align="justify" style="white-space: pre-line">{{ paps.risk_management }}</div>
                    ...
                    <div v-else>
                        <span style="color:red; font-weight: bold;">
                            ...
                            Click <Link :href="`/RiskManagement/${paps.id}`">here</Link> to edit risk management.
                        </span>
                        <br><br>
                    </div>
                    <!--SIGNATORIES-->
