<template>
    ...
    <div class="row gap-20 masonry pos-r">
        <div class="peers fxw-nw jc-sb ai-c">
            <h3>General Administration and Support (GAS) Profile</h3>
            <div class="peers">
                ...
                <div class="peer">
                    <Link class="btn btn-primary btn-sm"
                            :href="`/revision/general/administration/services/create/${FFUNCCOD}/plan`">Add Project Profile</Link>
        ...
        <div class="peers fxw-nw jc-sb ai-c">
            <h5>Program/Project: <u>General Administration and Support</u></h5>
        </div>
