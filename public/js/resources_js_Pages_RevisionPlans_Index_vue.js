...
var _hoisted_7 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createTextVNode)("Add Revision Plan");
...
}, [/*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createCommentVNode)("<li><Link class=\"dropdown-item\" :href=\"`/activities/${dat.id}`\">Activities</Link></li>\r\n                                            <li><Link class=\"dropdown-item\" :href=\"`/strategies/${dat.id}/${dat.idpaps}/edit`\">Edit</Link></li>\r\n                                            <li><Link class=\"text-danger dropdown-item\" @click=\"deleteStrat(dat.id)\">Delete</Link></li>")])])], -1
/* HOISTED */
);
