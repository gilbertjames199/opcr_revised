...
var __default__ = {
  ...
  mounted: function mounted() {
    ...
    if (this.editData !== undefined) {
      ...
      this.form.aip_code_child = this.editData.aip_code_child; // this.form.output_description=this.editData.output_description
  ...
  methods: {
    ...
    setOOEValue: function setOOEValue() {
      ...
      var tot = prog_sel[0].sem1 + prog_sel[0].sem2; // alert(tot);
...
var _hoisted_6 = /*#__PURE__*/(0,vue__WEBPACK_IMPORTED_MODULE_0__.createElementVNode)("label", null, "Objects of Expenditure", -1
/* HOISTED */
);
